...
<head>
  ...
  <title>Marc Márquez & Keluarga - Profil Lengkap</title>
  <style>
    body {
      ...
      margin: 30px auto;
      padding: 0 20px;
      /* background gradasi ungu ke pink */
    ...
    th, td {
      padding: 12px 15px;
      border: 1px solid #d7a9cc;
      text-align: left;
      vertical-align: middle;
    }
    th {
      background-color: #c96cc9;
      color: white;
      font-weight: 600;
    }
...
<section id="karier">
  ...
  <table>
    ...
    <tbody>
      ...
      <tr><td>2020-2022</td><td>Sempat mengalami cedera serius, namun terus berusaha kembali ke performa puncak</td></tr>
    </tbody>
  </table>
</section>
